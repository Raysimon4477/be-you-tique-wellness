  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4">
        ...
        />
        <p
          className="font-body text-primary-foreground text-sm md:text-base font-light max-w-lg text-center opacity-[0.88] mt-5"
        >
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-gold hover:bg-gold-light text-primary-foreground font-body text-sm tracking-wider uppercase px-12 py-5 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl mt-5"
        >
