  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-border/50">
      <div className="container mx-auto flex items-center justify-between py-4 px-4 md:px-8">
        <a href="#" className="font-heading text-2xl md:text-3xl font-semibold text-primary tracking-wide">
          Be'YOU'tique
        </a>
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="bg-gold hover:bg-gold-light text-primary-foreground font-body text-sm tracking-wider uppercase px-6 py-2.5 rounded-full transition-all duration-300"
          >
            Book Now
          </a>
        </nav>
