        ...
        <div className="max-w-3xl mx-auto grid md:grid-cols-3 gap-8 text-center mb-16">
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <a
                href="https://www.google.com/maps/dir/?api=1&destination=-33.88133,18.51762"
                target="_blank"
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="font-body text-muted-foreground text-sm leading-relaxed">
                <a href="tel:+27722679555" className="hover:text-primary transition-colors">072 267 9555</a><br />
